  ...
  <div class="content-wrapper">
    ...
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-info">
        ...
        <a href="{{route('admin.orders.index')}}" class="small-box-footer">Xem nhiều hơn <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-success">
        <div class="inner">
          <h3><?= number_format(35400000);?></h3>
          <p>Doanh số</p>
        </div>
        <div class="icon">
          <i class="ion ion-stats-bars"></i>
        </div>
        <a href="{{route('admin.doanh-thu')}}" class="small-box-footer">Xem nhiều hơn<i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-warning">
        ...
        <a href="{{route('admin.users.index')}}" class="small-box-footer">Xem nhiều hơn <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-danger">
        <div class="inner">
          ...
          <p>Số người vào cửa hàng trong ngày</p>
        </div>
        <div class="icon">
